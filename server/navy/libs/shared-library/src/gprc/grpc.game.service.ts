...
export const GameServiceName = 'GameService';
export const GameServiceGrpcClientName = 'gameservice';
export const GameServiceGrpcPackage = 'gameservice';

export const WorldServiceGrpcClientOptions: ClientOptions = {
    transport: Transport.GRPC,
    options: {
        url: 'localhost:' + Config.GAME_SERVICE_PORT,
        package: GameServiceGrpcPackage,
        protoPath: join(__dirname, '../../proto/game.service.proto'),
    },
};
