(function ($hx_exports, $global) {
	...
	var game_engine_IslandEngine = $hx_exports["game"]["engine"]["IslandEngine"] = function (engineMode) {
		if (engineMode == null) {
			engineMode = game_engine_EngineMode.Server;
		}
		this.lineColliders = [];
		game_engine_BaseEngine.call(this, engineMode, game_engine_EngineGameMode.Island, new game_engine_entity_manager_CharacterManager());
	...
	game_engine_IslandEngine.__name__ = true;
	game_engine_IslandEngine.main = function () {
	};
	game_engine_IslandEngine.__super__ = game_engine_BaseEngine;
	game_engine_IslandEngine.prototype = $extend(game_engine_BaseEngine.prototype, {
		...
		, engineLoopUpdate: function (dt) {
			...
			while (!_g_lastStep.done) {
				...
				character.update(dt);
				var char = js_Boot.__cast(character, game_engine_entity_EngineCharacterEntity);
		...
		, addLineCollider: function (x1, y1, x2, y2) {
			this.lineColliders.push(new game_engine_geometry_Line(x1, y1, x2, y2));
		}
		, entityMoveUp: function (id) {
			var character = js_Boot.__cast(this.mainEntityManager.getEntityById(id), game_engine_entity_EngineCharacterEntity);
		...
		, __class__: game_engine_IslandEngine
	});
	...
	var game_engine_entity_CurrentState = $hxEnums["game.engine.entity.CurrentState"] = {
		__ename__: true, __constructs__: null
		, Idle: { _hx_name: "Idle", _hx_index: 0, __enum__: "game.engine.entity.CurrentState", toString: $estr }
		, Moving: { _hx_name: "Moving", _hx_index: 1, __enum__: "game.engine.entity.CurrentState", toString: $estr }
	};
	game_engine_entity_CurrentState.__constructs__ = [game_engine_entity_CurrentState.Idle, game_engine_entity_CurrentState.Moving];
	var game_engine_entity_EngineCharacterEntity = function (baseObjectEntity) {
		this.wantToMoveDown = false;
		this.wantToMoveUp = false;
		this.wantToMoveRight = false;
		this.wantToMoveLeft = false;
		game_engine_entity_EngineBaseGameEntity.call(this, game_engine_entity_GameEntityType.Character, baseObjectEntity);
		this.shape.rectOffsetX = 60;
		this.shape.rectOffsetY = 60;
	};
	game_engine_entity_EngineCharacterEntity.__name__ = true;
	game_engine_entity_EngineCharacterEntity.__super__ = game_engine_entity_EngineBaseGameEntity;
	game_engine_entity_EngineCharacterEntity.prototype = $extend(game_engine_entity_EngineBaseGameEntity.prototype, {
		...
		, __class__: game_engine_entity_EngineCharacterEntity
	});
	...
	var game_engine_entity_manager_CharacterManager = function () {
		game_engine_entity_manager_BaseEntityManager.call(this);
	};
	game_engine_entity_manager_CharacterManager.__name__ = true;
	game_engine_entity_manager_CharacterManager.__super__ = game_engine_entity_manager_BaseEntityManager;
	game_engine_entity_manager_CharacterManager.prototype = $extend(game_engine_entity_manager_BaseEntityManager.prototype, {
		__class__: game_engine_entity_manager_CharacterManager
	});
