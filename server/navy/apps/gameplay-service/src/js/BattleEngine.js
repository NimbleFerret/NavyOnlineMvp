(function ($hx_exports, $global) {
	...
	game_engine_GameEngine.prototype = $extend(game_engine_BaseEngine.prototype, {
		...
		, engineLoopUpdate: function (dt) {
			...
			while (!_g_lastStep.done) {
				...
				if (ship.isAlive) {
					...
					if (engineShipEntity.role == game_engine_entity_Role.Bot && engineShipEntity.allowShoot) {
						engineShipEntity.allowShoot = false;
						this.shipShootBySide(game_engine_entity_Side.Right, engineShipEntity.getId(), null, 0);
					}
					var jsIterator = this.mainEntityManager.entities.values();
		...
		, shipShootBySide: function (side, shipId, serverSide, aimAngleRads, shellRnd) {
			...
			if (ship != null && ship.tryShoot(side)) {
				var shipSideRadRotation = aimAngleRads == 0 ? ship.rotation + game_engine_MathUtils.degreeToRads(side == game_engine_entity_Side.Left ? 90 : -90) : aimAngleRads;
				var shells = [];
				var cannonsTotal = 0;
				switch (ship.getShipCannons()._hx_index) {
					case 0:
						cannonsTotal = 1;
						break;
					case 1:
		...
		, addShell: function (entity) {
			var newShell = new game_engine_entity_EngineShellEntity(entity);
	...
	var game_engine_entity_EngineBaseGameEntity = function (entityType, baseObjectEntity) {
		...
		this.shape = game_engine_entity_EngineShipEntityConfig.EntityShapeByType.get(entityType);
	...
	var game_engine_entity_EngineShellEntity = function (shellObjectEntity) {
		...
		game_engine_entity_EngineBaseGameEntity.call(this, game_engine_entity_GameEntityType.Shell, shellObjectEntity);
	...
	var game_engine_entity_EngineShipEntity = function (shipObjectEntity) {
		...
		switch (this.shipObjectEntity.direction._hx_index) {
			case 0:
	...
	game_engine_entity_EngineShipEntity.getShipTypeBySize = function (size) {
		switch (size._hx_index) {
			case 0:
				return game_engine_entity_GameEntityType.SmallShip;
			case 1:
				return game_engine_entity_GameEntityType.MediumShip;
			case 2:
				return game_engine_entity_GameEntityType.LargeShip;
		}
	};
	...
	game_engine_entity_EngineShipEntity.prototype = $extend(game_engine_entity_EngineBaseGameEntity.prototype, {
		...
		, rotateLeft: function () {
			if (this.checkRotationInput()) {
				...
				switch (this.shipObjectEntity.direction._hx_index) {
					case 0:
						this.shipObjectEntity.direction = game_engine_entity_GameEntityDirection.NorthEast;
						break;
					case 1:
						this.shipObjectEntity.direction = game_engine_entity_GameEntityDirection.NorthWest;
						break;
					case 2:
						this.shipObjectEntity.direction = game_engine_entity_GameEntityDirection.North;
						break;
					case 3:
						this.shipObjectEntity.direction = game_engine_entity_GameEntityDirection.West;
						break;
					case 4:
						this.shipObjectEntity.direction = game_engine_entity_GameEntityDirection.SouthEast;
						break;
					case 5:
						this.shipObjectEntity.direction = game_engine_entity_GameEntityDirection.East;
						break;
					case 6:
						this.shipObjectEntity.direction = game_engine_entity_GameEntityDirection.South;
						break;
					case 7:
						this.shipObjectEntity.direction = game_engine_entity_GameEntityDirection.SouthWest;
						break;
				}
		...
		, shootAllowanceBySide: function (side) {
			var now = HxOverrides.now() / 1000;
			if (side == game_engine_entity_Side.Right) {
		...
		, getCannonsPositionBySide: function (side) {
			var result = [];
			var cannonsTotal = 0;
			switch (this.shipObjectEntity.shipCannons._hx_index) {
				case 0:
					cannonsTotal = 1;
					break;
				case 1:
		...
		, getCannonsFiringAreaBySide: function (side) {
			...
			while (_g < _g1) {
				...
				var lineHorizontalLength = x + (side == game_engine_entity_Side.Right ? this.shipObjectEntity.cannonsRange : -this.shipObjectEntity.cannonsRange);
		...
		, getCannonPositionBySideAndIndex: function (side, index) {
			...
			if (side == game_engine_entity_Side.Left) {
				if (direction == game_engine_entity_GameEntityDirection.East) {
					additionalOffsetX = 0;
					additionalOffsetY = 20;
				}
				if (direction == game_engine_entity_GameEntityDirection.NorthEast) {
					additionalOffsetX = 14;
					additionalOffsetY = 8;
				}
				if (direction == game_engine_entity_GameEntityDirection.North) {
					additionalOffsetX = 20;
					additionalOffsetY = 0;
				}
				if (direction == game_engine_entity_GameEntityDirection.NorthWest) {
					additionalOffsetX = 14;
					additionalOffsetY = -8;
				}
				if (direction == game_engine_entity_GameEntityDirection.West) {
					additionalOffsetX = 0;
					additionalOffsetY = -20;
				}
				if (direction == game_engine_entity_GameEntityDirection.SouthWest) {
					additionalOffsetX = -14;
					additionalOffsetY = -8;
				}
				if (direction == game_engine_entity_GameEntityDirection.SouthEast) {
					additionalOffsetX = -14;
					additionalOffsetY = 8;
				}
				if (direction == game_engine_entity_GameEntityDirection.South) {
					additionalOffsetX = -20;
					additionalOffsetY = 0;
				}
			} else {
			...
			if (this.shipObjectEntity.shipHullSize == game_engine_entity_ShipHullSize.MEDIUM) {
				offset = side == game_engine_entity_Side.Left ? game_engine_entity_EngineShipEntityConfig.LeftCannonsOffsetByDirMid.get(direction) : game_engine_entity_EngineShipEntityConfig.RightCannonsOffsetByDirMid.get(direction);
			} else {
				offset = side == game_engine_entity_Side.Left ? game_engine_entity_EngineShipEntityConfig.LeftCannonsOffsetByDirSm.get(direction) : game_engine_entity_EngineShipEntityConfig.RightCannonsOffsetByDirSm.get(direction);
			}
	...
	var game_engine_entity_GameEntityType = $hxEnums["game.engine.entity.GameEntityType"] = {
		__ename__: true, __constructs__: null
		, SmallShip: { _hx_name: "SmallShip", _hx_index: 0, __enum__: "game.engine.entity.GameEntityType", toString: $estr }
		, MediumShip: { _hx_name: "MediumShip", _hx_index: 1, __enum__: "game.engine.entity.GameEntityType", toString: $estr }
		, LargeShip: { _hx_name: "LargeShip", _hx_index: 2, __enum__: "game.engine.entity.GameEntityType", toString: $estr }
		, Shell: { _hx_name: "Shell", _hx_index: 3, __enum__: "game.engine.entity.GameEntityType", toString: $estr }
		, Character: { _hx_name: "Character", _hx_index: 4, __enum__: "game.engine.entity.GameEntityType", toString: $estr }
	};
	game_engine_entity_GameEntityType.__constructs__ = [game_engine_entity_GameEntityType.SmallShip, game_engine_entity_GameEntityType.MediumShip, game_engine_entity_GameEntityType.LargeShip, game_engine_entity_GameEntityType.Shell, game_engine_entity_GameEntityType.Character];
	...
	var game_engine_entity_GameEntityDirection = $hxEnums["game.engine.entity.GameEntityDirection"] = {
		__ename__: true, __constructs__: null
		, East: { _hx_name: "East", _hx_index: 0, __enum__: "game.engine.entity.GameEntityDirection", toString: $estr }
		, North: { _hx_name: "North", _hx_index: 1, __enum__: "game.engine.entity.GameEntityDirection", toString: $estr }
		, NorthEast: { _hx_name: "NorthEast", _hx_index: 2, __enum__: "game.engine.entity.GameEntityDirection", toString: $estr }
		, NorthWest: { _hx_name: "NorthWest", _hx_index: 3, __enum__: "game.engine.entity.GameEntityDirection", toString: $estr }
		, South: { _hx_name: "South", _hx_index: 4, __enum__: "game.engine.entity.GameEntityDirection", toString: $estr }
		, SouthEast: { _hx_name: "SouthEast", _hx_index: 5, __enum__: "game.engine.entity.GameEntityDirection", toString: $estr }
		, SouthWest: { _hx_name: "SouthWest", _hx_index: 6, __enum__: "game.engine.entity.GameEntityDirection", toString: $estr }
		, West: { _hx_name: "West", _hx_index: 7, __enum__: "game.engine.entity.GameEntityDirection", toString: $estr }
	};
	game_engine_entity_GameEntityDirection.__constructs__ = [game_engine_entity_GameEntityDirection.East, game_engine_entity_GameEntityDirection.North, game_engine_entity_GameEntityDirection.NorthEast, game_engine_entity_GameEntityDirection.NorthWest, game_engine_entity_GameEntityDirection.South, game_engine_entity_GameEntityDirection.SouthEast, game_engine_entity_GameEntityDirection.SouthWest, game_engine_entity_GameEntityDirection.West];
	var game_engine_entity_EngineShipEntityConfig = function () { };
	game_engine_entity_EngineShipEntityConfig.__name__ = true;
	var game_engine_entity_Side = $hxEnums["game.engine.entity.Side"] = {
		__ename__: true, __constructs__: null
		, Left: { _hx_name: "Left", _hx_index: 0, __enum__: "game.engine.entity.Side", toString: $estr }
		, Right: { _hx_name: "Right", _hx_index: 1, __enum__: "game.engine.entity.Side", toString: $estr }
	};
	game_engine_entity_Side.__constructs__ = [game_engine_entity_Side.Left, game_engine_entity_Side.Right];
	var game_engine_entity_Role = $hxEnums["game.engine.entity.Role"] = {
		__ename__: true, __constructs__: null
		, Bot: { _hx_name: "Bot", _hx_index: 0, __enum__: "game.engine.entity.Role", toString: $estr }
		, Boss: { _hx_name: "Boss", _hx_index: 1, __enum__: "game.engine.entity.Role", toString: $estr }
		, Player: { _hx_name: "Player", _hx_index: 2, __enum__: "game.engine.entity.Role", toString: $estr }
	};
	game_engine_entity_Role.__constructs__ = [game_engine_entity_Role.Bot, game_engine_entity_Role.Boss, game_engine_entity_Role.Player];
	var game_engine_entity_ShipHullSize = $hxEnums["game.engine.entity.ShipHullSize"] = {
		__ename__: true, __constructs__: null
		, SMALL: { _hx_name: "SMALL", _hx_index: 0, __enum__: "game.engine.entity.ShipHullSize", toString: $estr }
		, MEDIUM: { _hx_name: "MEDIUM", _hx_index: 1, __enum__: "game.engine.entity.ShipHullSize", toString: $estr }
		, LARGE: { _hx_name: "LARGE", _hx_index: 2, __enum__: "game.engine.entity.ShipHullSize", toString: $estr }
	};
	game_engine_entity_ShipHullSize.__constructs__ = [game_engine_entity_ShipHullSize.SMALL, game_engine_entity_ShipHullSize.MEDIUM, game_engine_entity_ShipHullSize.LARGE];
	var game_engine_entity_ShipWindows = $hxEnums["game.engine.entity.ShipWindows"] = {
		__ename__: true, __constructs__: null
		, ONE: { _hx_name: "ONE", _hx_index: 0, __enum__: "game.engine.entity.ShipWindows", toString: $estr }
		, TWO: { _hx_name: "TWO", _hx_index: 1, __enum__: "game.engine.entity.ShipWindows", toString: $estr }
		, NONE: { _hx_name: "NONE", _hx_index: 2, __enum__: "game.engine.entity.ShipWindows", toString: $estr }
	};
	game_engine_entity_ShipWindows.__constructs__ = [game_engine_entity_ShipWindows.ONE, game_engine_entity_ShipWindows.TWO, game_engine_entity_ShipWindows.NONE];
	var game_engine_entity_ShipCannons = $hxEnums["game.engine.entity.ShipCannons"] = {
		__ename__: true, __constructs__: null
		, ONE: { _hx_name: "ONE", _hx_index: 0, __enum__: "game.engine.entity.ShipCannons", toString: $estr }
		, TWO: { _hx_name: "TWO", _hx_index: 1, __enum__: "game.engine.entity.ShipCannons", toString: $estr }
		, THREE: { _hx_name: "THREE", _hx_index: 2, __enum__: "game.engine.entity.ShipCannons", toString: $estr }
		, FOUR: { _hx_name: "FOUR", _hx_index: 3, __enum__: "game.engine.entity.ShipCannons", toString: $estr }
		, ZERO: { _hx_name: "ZERO", _hx_index: 4, __enum__: "game.engine.entity.ShipCannons", toString: $estr }
	};
	game_engine_entity_ShipCannons.__constructs__ = [game_engine_entity_ShipCannons.ONE, game_engine_entity_ShipCannons.TWO, game_engine_entity_ShipCannons.THREE, game_engine_entity_ShipCannons.FOUR, game_engine_entity_ShipCannons.ZERO];
	...
	game_engine_entity_EngineShipEntityConfig.EntityShapeByType = (function ($this) {
		...
		_g.set(game_engine_entity_GameEntityType.SmallShip, new game_engine_entity_EntityShape(200, 80));
		_g.set(game_engine_entity_GameEntityType.MediumShip, new game_engine_entity_EntityShape(300, 120));
		_g.set(game_engine_entity_GameEntityType.Shell, new game_engine_entity_EntityShape(10, 10));
		_g.set(game_engine_entity_GameEntityType.Character, new game_engine_entity_EntityShape(60, 60));
		$r = _g;
		return $r;
	}(this));
	game_engine_entity_EngineShipEntityConfig.ShapeOffsetByDir = (function ($this) {
		var $r;
		var _g = new haxe_ds_EnumValueMap();
		_g.set(game_engine_entity_GameEntityDirection.East, new game_engine_entity_PosOffset(0, -100, -40));
		_g.set(game_engine_entity_GameEntityDirection.North, new game_engine_entity_PosOffset(-90, -50, 110));
		_g.set(game_engine_entity_GameEntityDirection.NorthEast, new game_engine_entity_PosOffset(-26, -110, 19));
		_g.set(game_engine_entity_GameEntityDirection.NorthWest, new game_engine_entity_PosOffset(-155, -65, 87));
		_g.set(game_engine_entity_GameEntityDirection.South, new game_engine_entity_PosOffset(90, 26, 72));
		_g.set(game_engine_entity_GameEntityDirection.SouthEast, new game_engine_entity_PosOffset(26, -80, -6));
		_g.set(game_engine_entity_GameEntityDirection.SouthWest, new game_engine_entity_PosOffset(-23, -113, 19));
		_g.set(game_engine_entity_GameEntityDirection.West, new game_engine_entity_PosOffset(0, -110, -42));
		$r = _g;
		return $r;
	}(this));
	game_engine_entity_EngineShipEntityConfig.RightCannonsOffsetByDirSm = (function ($this) {
		var $r;
		var _g = new haxe_ds_EnumValueMap();
		_g.set(game_engine_entity_GameEntityDirection.East, new game_engine_entity_PosOffsetArray([new game_engine_entity_PosOffset(-28, 26), new game_engine_entity_PosOffset(0, 26), new game_engine_entity_PosOffset(28, 26)]));
		_g.set(game_engine_entity_GameEntityDirection.NorthEast, new game_engine_entity_PosOffsetArray([new game_engine_entity_PosOffset(17, 31), new game_engine_entity_PosOffset(36, 21), new game_engine_entity_PosOffset(55, 13)]));
		_g.set(game_engine_entity_GameEntityDirection.North, new game_engine_entity_PosOffsetArray([new game_engine_entity_PosOffset(50, 10), new game_engine_entity_PosOffset(50, -13), new game_engine_entity_PosOffset(50, 33)]));
		_g.set(game_engine_entity_GameEntityDirection.NorthWest, new game_engine_entity_PosOffsetArray([new game_engine_entity_PosOffset(50, -16), new game_engine_entity_PosOffset(28, -26), new game_engine_entity_PosOffset(7, -33)]));
		_g.set(game_engine_entity_GameEntityDirection.West, new game_engine_entity_PosOffsetArray([new game_engine_entity_PosOffset(50, -50), new game_engine_entity_PosOffset(21, -50), new game_engine_entity_PosOffset(-8, -50)]));
		_g.set(game_engine_entity_GameEntityDirection.SouthWest, new game_engine_entity_PosOffsetArray([new game_engine_entity_PosOffset(-10, -41), new game_engine_entity_PosOffset(-27, -34), new game_engine_entity_PosOffset(-41, -27)]));
		_g.set(game_engine_entity_GameEntityDirection.South, new game_engine_entity_PosOffsetArray([new game_engine_entity_PosOffset(-50, -31), new game_engine_entity_PosOffset(-50, -11), new game_engine_entity_PosOffset(-50, 10)]));
		_g.set(game_engine_entity_GameEntityDirection.SouthEast, new game_engine_entity_PosOffsetArray([new game_engine_entity_PosOffset(-70, 10), new game_engine_entity_PosOffset(-50, 19), new game_engine_entity_PosOffset(-28, 29)]));
		$r = _g;
		return $r;
	}(this));
	game_engine_entity_EngineShipEntityConfig.LeftCannonsOffsetByDirSm = (function ($this) {
		var $r;
		var _g = new haxe_ds_EnumValueMap();
		_g.set(game_engine_entity_GameEntityDirection.East, new game_engine_entity_PosOffsetArray([new game_engine_entity_PosOffset(-28, -52), new game_engine_entity_PosOffset(0, -52), new game_engine_entity_PosOffset(28, -52)]));
		_g.set(game_engine_entity_GameEntityDirection.NorthEast, new game_engine_entity_PosOffsetArray([new game_engine_entity_PosOffset(-55, -16), new game_engine_entity_PosOffset(-35, -24), new game_engine_entity_PosOffset(-16, -32)]));
		_g.set(game_engine_entity_GameEntityDirection.North, new game_engine_entity_PosOffsetArray([new game_engine_entity_PosOffset(-50, 10), new game_engine_entity_PosOffset(-50, -13), new game_engine_entity_PosOffset(-50, 33)]));
		_g.set(game_engine_entity_GameEntityDirection.NorthWest, new game_engine_entity_PosOffsetArray([new game_engine_entity_PosOffset(-13, 32), new game_engine_entity_PosOffset(-32, 22), new game_engine_entity_PosOffset(-52, 11)]));
		_g.set(game_engine_entity_GameEntityDirection.West, new game_engine_entity_PosOffsetArray([new game_engine_entity_PosOffset(50, 27), new game_engine_entity_PosOffset(21, 27), new game_engine_entity_PosOffset(-8, 27)]));
		_g.set(game_engine_entity_GameEntityDirection.SouthWest, new game_engine_entity_PosOffsetArray([new game_engine_entity_PosOffset(70, 5), new game_engine_entity_PosOffset(50, 15), new game_engine_entity_PosOffset(31, 25)]));
		_g.set(game_engine_entity_GameEntityDirection.South, new game_engine_entity_PosOffsetArray([new game_engine_entity_PosOffset(50, -31), new game_engine_entity_PosOffset(50, -11), new game_engine_entity_PosOffset(50, 10)]));
		_g.set(game_engine_entity_GameEntityDirection.SouthEast, new game_engine_entity_PosOffsetArray([new game_engine_entity_PosOffset(11, -32), new game_engine_entity_PosOffset(27, -25), new game_engine_entity_PosOffset(46, -15)]));
		$r = _g;
		return $r;
	}(this));
	game_engine_entity_EngineShipEntityConfig.RightCannonsOffsetByDirMid = (function ($this) {
		var $r;
		var _g = new haxe_ds_EnumValueMap();
		_g.set(game_engine_entity_GameEntityDirection.East, new game_engine_entity_PosOffsetArray([new game_engine_entity_PosOffset(-49, 54), new game_engine_entity_PosOffset(-19, 54), new game_engine_entity_PosOffset(11, 54), new game_engine_entity_PosOffset(41, 54)]));
		_g.set(game_engine_entity_GameEntityDirection.NorthEast, new game_engine_entity_PosOffsetArray([new game_engine_entity_PosOffset(21, 51), new game_engine_entity_PosOffset(47, 38), new game_engine_entity_PosOffset(72, 25), new game_engine_entity_PosOffset(96, 12)]));
		_g.set(game_engine_entity_GameEntityDirection.North, new game_engine_entity_PosOffsetArray([new game_engine_entity_PosOffset(47, 8), new game_engine_entity_PosOffset(47, -13), new game_engine_entity_PosOffset(47, -34), new game_engine_entity_PosOffset(47, -55)]));
		_g.set(game_engine_entity_GameEntityDirection.NorthWest, new game_engine_entity_PosOffsetArray([new game_engine_entity_PosOffset(27, -17), new game_engine_entity_PosOffset(5, -28), new game_engine_entity_PosOffset(-19, -40), new game_engine_entity_PosOffset(-42, -51)]));
		_g.set(game_engine_entity_GameEntityDirection.West, new game_engine_entity_PosOffsetArray([new game_engine_entity_PosOffset(0, -59), new game_engine_entity_PosOffset(-24, -59), new game_engine_entity_PosOffset(-51, -59), new game_engine_entity_PosOffset(-78, -59)]));
		_g.set(game_engine_entity_GameEntityDirection.SouthWest, new game_engine_entity_PosOffsetArray([new game_engine_entity_PosOffset(-61, -28), new game_engine_entity_PosOffset(-82, -17), new game_engine_entity_PosOffset(-103, -6), new game_engine_entity_PosOffset(-125, 5)]));
		_g.set(game_engine_entity_GameEntityDirection.South, new game_engine_entity_PosOffsetArray([new game_engine_entity_PosOffset(-87, -10), new game_engine_entity_PosOffset(-87, 10), new game_engine_entity_PosOffset(-87, 30), new game_engine_entity_PosOffset(-87, 50)]));
		_g.set(game_engine_entity_GameEntityDirection.SouthEast, new game_engine_entity_PosOffsetArray([new game_engine_entity_PosOffset(-82, 33), new game_engine_entity_PosOffset(-60, 44), new game_engine_entity_PosOffset(-39, 54), new game_engine_entity_PosOffset(-18, 64)]));
		$r = _g;
		return $r;
	}(this));
	game_engine_entity_EngineShipEntityConfig.LeftCannonsOffsetByDirMid = (function ($this) {
		var $r;
		var _g = new haxe_ds_EnumValueMap();
		_g.set(game_engine_entity_GameEntityDirection.East, new game_engine_entity_PosOffsetArray([new game_engine_entity_PosOffset(-43, -59), new game_engine_entity_PosOffset(-15, -59), new game_engine_entity_PosOffset(13, -59), new game_engine_entity_PosOffset(41, -59)]));
		_g.set(game_engine_entity_GameEntityDirection.NorthEast, new game_engine_entity_PosOffsetArray([new game_engine_entity_PosOffset(-63, -20), new game_engine_entity_PosOffset(-43, -30), new game_engine_entity_PosOffset(-23, -40), new game_engine_entity_PosOffset(-3, -50)]));
		_g.set(game_engine_entity_GameEntityDirection.North, new game_engine_entity_PosOffsetArray([new game_engine_entity_PosOffset(-87, 8), new game_engine_entity_PosOffset(-87, -13), new game_engine_entity_PosOffset(-87, -34), new game_engine_entity_PosOffset(-87, -55)]));
		_g.set(game_engine_entity_GameEntityDirection.NorthWest, new game_engine_entity_PosOffsetArray([new game_engine_entity_PosOffset(-60, 48), new game_engine_entity_PosOffset(-81, 38), new game_engine_entity_PosOffset(-102, 28), new game_engine_entity_PosOffset(-123, 18)]));
		_g.set(game_engine_entity_GameEntityDirection.West, new game_engine_entity_PosOffsetArray([new game_engine_entity_PosOffset(0, 54), new game_engine_entity_PosOffset(-24, 54), new game_engine_entity_PosOffset(-51, 54), new game_engine_entity_PosOffset(-78, 54)]));
		_g.set(game_engine_entity_GameEntityDirection.SouthWest, new game_engine_entity_PosOffsetArray([new game_engine_entity_PosOffset(42, 36), new game_engine_entity_PosOffset(24, 44), new game_engine_entity_PosOffset(-3, 59), new game_engine_entity_PosOffset(-26, 70)]));
		_g.set(game_engine_entity_GameEntityDirection.South, new game_engine_entity_PosOffsetArray([new game_engine_entity_PosOffset(48, -10), new game_engine_entity_PosOffset(48, 10), new game_engine_entity_PosOffset(48, 30), new game_engine_entity_PosOffset(48, 50)]));
		_g.set(game_engine_entity_GameEntityDirection.SouthEast, new game_engine_entity_PosOffsetArray([new game_engine_entity_PosOffset(25, -26), new game_engine_entity_PosOffset(47, -16), new game_engine_entity_PosOffset(70, -4), new game_engine_entity_PosOffset(93, 6)]));
		$r = _g;
		return $r;
	}(this));
	game_engine_entity_EngineShipEntityConfig.RightSideRectOffsetByDir = (function ($this) {
		var $r;
		var _g = new haxe_ds_EnumValueMap();
		_g.set(game_engine_entity_GameEntityDirection.East, new game_engine_entity_PosOffset(0, 0, 0));
		_g.set(game_engine_entity_GameEntityDirection.North, new game_engine_entity_PosOffset(0, 0, 0));
		_g.set(game_engine_entity_GameEntityDirection.NorthEast, new game_engine_entity_PosOffset(0, 0, 0));
		_g.set(game_engine_entity_GameEntityDirection.NorthWest, new game_engine_entity_PosOffset(0, 0, 0));
		_g.set(game_engine_entity_GameEntityDirection.South, new game_engine_entity_PosOffset(0, 0, 0));
		_g.set(game_engine_entity_GameEntityDirection.SouthEast, new game_engine_entity_PosOffset(0, 0, 0));
		_g.set(game_engine_entity_GameEntityDirection.SouthWest, new game_engine_entity_PosOffset(0, 0, 0));
		_g.set(game_engine_entity_GameEntityDirection.West, new game_engine_entity_PosOffset(0, 0, 0));
		$r = _g;
		return $r;
	}(this));
