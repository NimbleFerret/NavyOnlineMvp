(function ($hx_exports, $global) {
    ...
    var game_engine_base_EngineUtils = function () { };
    game_engine_base_EngineUtils.__name__ = true;
    game_engine_base_EngineUtils.HashString = function (str) {
    ...
    var game_engine_navy_NavyEngineConfig = function () { };
    game_engine_navy_NavyEngineConfig.__name__ = true;
    var game_engine_navy_NavyGameEngine = $hx_exports["game"]["engine"]["navy"]["NavyGameEngine"] = function (engineMode) {
        if (engineMode == null) {
            engineMode = game_engine_base_core_EngineMode.Server;
        }
        this.botShootDelaySeconds = 3;
        this.lastBotShootTime = 0.0;
        this.timePassed = 0.0;
        this.botsAllowShoot = false;
        this.allowShoot = false;
        this.framesPassed = 0;
        this.enableCollisions = true;
        this.enableShooting = true;
        this.shellManager = new game_engine_navy_entity_manager_ShellManager();
        game_engine_base_core_BaseEngine.call(this, engineMode, game_engine_base_core_EngineGameMode.Sea, new game_engine_navy_entity_manager_ShipManager());
    };
    game_engine_navy_NavyGameEngine.__name__ = true;
    game_engine_navy_NavyGameEngine.main = function () {
    };
    game_engine_navy_NavyGameEngine.__super__ = game_engine_base_core_BaseEngine;
    game_engine_navy_NavyGameEngine.prototype = $extend(game_engine_base_core_BaseEngine.prototype, {
        processInputCommands: function (inputs) {
            ...
            while (_g < inputs.length) {
                ...
                var ship = js_Boot.__cast(this.mainEntityManager.getEntityById(entityId), game_engine_navy_entity_NavyShipEntity);
                ...
                switch (input.inputType) {
                    ...
                    case 5:
                        if (this.enableShooting) {
                            var shootDetails = input.shootDetails;
                            var side = shootDetails.side;
                            if (ship != null && ship.tryShoot(side)) {
                                var aimAngleRads = shootDetails.aimAngleRads;
                                var shipSideRadRotation = aimAngleRads == 0 ? ship.getRotation() + game_engine_base_MathUtils.degreeToRads(side == 1 ? 90 : -90) : aimAngleRads;
                                var shells = [];
                                var cannonsTotal = 0;
                                ...
                                if (this.createShellCallback != null) {
                                    this.createShellCallback({ shells: shells, side: side, aimAngleRads: aimAngleRads, shooterId: inputInitiator });
                                }
                            }
                        }
                        break;
        ...
        , engineLoopUpdate: function (dt) {
            ...
            this.framesPassed++;
            this.timePassed += dt;
            if (this.engineMode == game_engine_base_core_EngineMode.Server) {
                if (this.lastBotShootTime == 0) {
                    this.lastBotShootTime = this.timePassed;
                } else if (this.timePassed - this.lastBotShootTime >= this.botShootDelaySeconds) {
                    this.lastBotShootTime = this.timePassed;
                    this.botsAllowShoot = true;
                }
            }
                    ...
                    if (this.enableCollisions) {
                        ...
                        while (!_g1_lastStep1.done) {
                            ...
                            if (shell.getOwnerId() != ship.getOwnerId() && ship.isAlive) {
                                if (this.checkShellAndShipCollision(shell, ship)) {
                                    ship.collides(true);
                                    shell.collides(true);
                                    var engineShipEntity = js_Boot.__cast(ship, game_engine_navy_entity_NavyShipEntity);
                                    var engineShellEntity = js_Boot.__cast(shell, game_engine_navy_entity_NavyShellEntity);
            ...
            while (_g < _g1) {
                var i = _g++;
                var shell = js_Boot.__cast(this.shellManager.getEntityById(shellsToDelete[i]), game_engine_navy_entity_NavyShellEntity);
                if (shell != null) {
            ...
            while (_g < _g1) {
                var i = _g++;
                var ship = js_Boot.__cast(this.mainEntityManager.getEntityById(shipsToDelete[i]), game_engine_navy_entity_NavyShipEntity);
                if (ship != null) {
        ...
        , buildEngineEntity: function (struct) {
            return new game_engine_navy_entity_NavyShipEntity(new game_engine_navy_ShipObjectEntity(struct));
        }
        , checkShellAndShipCollision: function (shell, ship) {
            ...
            return ship.getBodyRectangle().intersectsWithLine(new game_engine_base_geometry_Line(shellLine.p1.x, shellLine.p1.y, shellLine.p2.x, shellLine.p2.y));
        }
        , addShell: function (entity) {
            var newShell = new game_engine_navy_entity_NavyShellEntity(new game_engine_navy_ShellObjectEntity(entity));
        ...
        , __class__: game_engine_navy_NavyGameEngine
    });
    ...
    var game_engine_navy_entity_DieEffect = $hxEnums["game.engine.navy.entity.DieEffect"] = {
        __ename__: true, __constructs__: null
        , Splash: { _hx_name: "Splash", _hx_index: 0, __enum__: "game.engine.navy.entity.DieEffect", toString: $estr }
        , Explosion: { _hx_name: "Explosion", _hx_index: 1, __enum__: "game.engine.navy.entity.DieEffect", toString: $estr }
    };
    game_engine_navy_entity_DieEffect.__constructs__ = [game_engine_navy_entity_DieEffect.Splash, game_engine_navy_entity_DieEffect.Explosion];
    var game_engine_navy_entity_NavyShellEntity = function (shellObjectEntity) {
        this.dieEffect = game_engine_navy_entity_DieEffect.Splash;
        this.preUpdatePos = new game_engine_base_geometry_Point();
        this.distanceTraveled = 0.0;
        game_engine_base_entity_EngineBaseGameEntity.call(this, shellObjectEntity, game_engine_navy_entity_NavyEntitiesConfig.EntityShapeByType.h[4]);
        this.shellObjectEntity = shellObjectEntity;
        this.customUpdate = this;
        this.customCollide = this;
    };
    game_engine_navy_entity_NavyShellEntity.__name__ = true;
    game_engine_navy_entity_NavyShellEntity.__interfaces__ = [game_engine_base_entity_GameEntityCustomCollide, game_engine_base_entity_GameEntityCustomUpdate];
    game_engine_navy_entity_NavyShellEntity.__super__ = game_engine_base_entity_EngineBaseGameEntity;
    game_engine_navy_entity_NavyShellEntity.prototype = $extend(game_engine_base_entity_EngineBaseGameEntity.prototype, {
        ...
        , postUpdate: function () {
            var newPos = new game_engine_base_geometry_Point(this.getX(), this.getY());
        ...
        , onCollide: function () {
            this.isAlive = false;
            this.dieEffect = game_engine_navy_entity_DieEffect.Explosion;
        }
        , getSide: function () {
        ...
        , __class__: game_engine_navy_entity_NavyShellEntity
    });
    var game_engine_navy_entity_NavyShipEntity = function (shipObjectEntity) {
        this.allowShoot = false;
        ...
        switch (this.shipObjectEntity.direction) {
            case 1:
                ...
                break;
            case 2:
                this.setRotation(game_engine_base_MathUtils.degreeToRads(-90));
                break;
            case 3:
                this.setRotation(game_engine_base_MathUtils.degreeToRads(-45));
                break;
            case 4:
                this.setRotation(-game_engine_base_MathUtils.degreeToRads(135));
                break;
            case 5:
                this.setRotation(-game_engine_base_MathUtils.degreeToRads(-90));
                break;
            ...
            case 7:
                ...
                break;
            case 8:
                this.setRotation(-game_engine_base_MathUtils.degreeToRads(180));
                break;
        }
    };
    game_engine_navy_entity_NavyShipEntity.__name__ = true;
    game_engine_navy_entity_NavyShipEntity.getShipTypeBySize = function (size) {
        switch (size) {
            case 1:
                return 1;
            case 2:
    ...
    game_engine_navy_entity_NavyShipEntity.__super__ = game_engine_base_entity_EngineBaseGameEntity;
    game_engine_navy_entity_NavyShipEntity.prototype = $extend(game_engine_base_entity_EngineBaseGameEntity.prototype, {
        canMove: function (playerInputType) {
            var result = true;
        ...
        , updateHashImpl: function () {
            ...
            var s = e.id + e.x + e.y + e.direction + this.currentArmor + this.currentHull;
            var hc = game_engine_base_EngineUtils.HashString(s);
            return hc;
        }
    ...
    var game_engine_navy_entity_manager_ShellManager = function () {
        game_engine_base_entity_manager_BaseEntityManager.call(this);
    };
    game_engine_navy_entity_manager_ShellManager.__name__ = true;
    game_engine_navy_entity_manager_ShellManager.__super__ = game_engine_base_entity_manager_BaseEntityManager;
    game_engine_navy_entity_manager_ShellManager.prototype = $extend(game_engine_base_entity_manager_BaseEntityManager.prototype, {
        __class__: game_engine_navy_entity_manager_ShellManager
    });
    var game_engine_navy_entity_manager_ShipManager = function () {
        game_engine_base_entity_manager_BaseEntityManager.call(this);
    };
    game_engine_navy_entity_manager_ShipManager.__name__ = true;
    game_engine_navy_entity_manager_ShipManager.__super__ = game_engine_base_entity_manager_BaseEntityManager;
    game_engine_navy_entity_manager_ShipManager.prototype = $extend(game_engine_base_entity_manager_BaseEntityManager.prototype, {
        __class__: game_engine_navy_entity_manager_ShipManager
    });
    ...
    game_engine_navy_NavyEngineConfig.ShellRandomSpeedFactor = 0;
    game_engine_navy_NavyEngineConfig.ShellRandomAngleSpreadDegree = 0;
    game_engine_navy_NavyEngineConfig.ShellDefaultSpeed = 380;
    game_engine_navy_NavyEngineConfig.ShipHull = 1000;
    game_engine_navy_NavyEngineConfig.ShipArmor = 1000;
    game_engine_navy_NavyEngineConfig.ShipCannonsRange = 600;
    game_engine_navy_NavyEngineConfig.ShipCannonsDamage = 50;
    game_engine_navy_NavyEngineConfig.ShipCccDelay = 1.0;
    game_engine_navy_NavyEngineConfig.ShipTurnDelay = 1.0;
    game_engine_navy_NavyEngineConfig.ShipFireDelay = 0.200;
    ...
    game_engine_navy_NavyGameEngine.main();
