...
class SceneDemo1 extends Scene {
	...
	public function start() {
		...
		final ship1 = game.addShipByClient(Role.Player, -200, 100, ShipHullSize.MEDIUM, ShipWindows.NONE, ShipGuns.FOUR, 300, 20, 500, 500, 300, 50, 0.500,
			0.500, 0.500, null, playerId);

		// final ship2 = game.addShipByClient(Role.Bot, -200, -200, ShipHullSize.SMALL, ShipWindows.NONE, ShipGuns.THREE, 300, 400, 500, 500, 300, 50, 0.500,
